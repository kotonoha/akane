...
object JumanPosReader {
  ...
  def fromClasspath() = {
    val conjFile = Resource.fromClasspath("juman/JUMAN.katuyou").string(Codec.UTF8)
    val gramFile = Resource.fromClasspath("juman/JUMAN.grammar").string(Codec.UTF8)
    val relFile = Resource.fromClasspath("juman/JUMAN.kankei").string(Codec.UTF8)
